...
INSERT INTO pokemon VALUES (NULL, 1,'Bulbasaur', 118, 118, 90);
INSERT INTO pokemon VALUES (NULL, 2,'Ivysaur', 151, 151, 120);
INSERT INTO pokemon VALUES (NULL, 3,'Venusaur', 198, 198, 160);
...
CREATE TABLE evolutions (id INT NOT NULL AUTO_INCREMENT,
                        ...
                        FOREIGN KEY (candy_id) REFERENCES pokemon(id)
					);
